<?php
     ...
     */
    class Row extends NotORMBase implements IteratorAggregate, ArrayAccess, Countable, JsonSerializable
    {
        ...
        {
            if ($this->result->notORM->cache && ! isset($this->modified[$key]) && $this->result->access(
                    $key,
                    $delete
                )
            ) {
        ...
        /**
         * @dogstar 2014-10-24
         * @todo method $this->row() now found
         * @return mixed
         */
