<?php
     ...
     */
    class NotORM extends NotORMBase
    {
         ...
         * @param IStructure $structure null for new StructureConvention
         * @param ICache     $cache     null for no cache
         */
        public function __construct(PDO $connection, IStructure $structure = null, ICache $cache = null)
        {
